...
namespace EAP.ModelFirst.Controls.Editors.DiagramEditor.ClassDiagram.Connections
{
	public abstract class Connection : DiagramElement
	{
        ...
        {
            return ConnectionKryptonContextMenu.Default.GetMenuItems(diagram);
        }
