...
namespace EAP.ModelFirst.Controls.Editors.DiagramEditor.ClassDiagram.Shapes
{
    public abstract class TypeShape : Shape
    {
        ...
        void typeBase_Modified(object sender, EventArgs e)
        {
            UpdateMinSize();
        }
        ...
        protected abstract EditorWindow HeaderEditor
        {
            get;
        }
        ...
        protected Color GetForeColor(Color c)
        {
            return ForeColor.IsEmpty ? c : ForeColor;
        }

        Color GetBackColor(Style style)
        {
            return BackColor.IsEmpty ? GetBackgroundColor(style) : BackColor;
        }

        Color GetHeadColor(Style style)
        {
            return BackColor.IsEmpty ? GetHeaderColor(style) : BackColor;
        }
        ...
        {
            return TypeShapeKryptonContextMenu.Default.GetMenuItems(diagram);
        }
        ...
        protected override void OnMove(MoveEventArgs e)
        {
            ...
            RelationShipEditor.Relocate(this);
        }
        ...
        {
            Color backColor = GetBackColor(style);
            Color headerColor = GetHeadColor(style);
            ...
            else
            {
                ...
                {
                    solidHeaderBrush.Color = GetHeadColor(style);
        ...
        {
            string name = GetHeaderText();
            RectangleF textRegion = CaptionRegion;

            // Update styles
            nameBrush.Color = GetForeColor(style.NameColor);
            identifierBrush.Color = GetForeColor(style.IdentifierColor);
        ...
        {
            return Diagram.Package == TypeBase.Package ? TypeBase.Name
                : TypeBase.GetPackageName("::", false) + TypeBase.Name;
        }
        ...
        protected override float GetRequiredWidth(Graphics g, Style style)
        {
            ...
            nameWidth = g.MeasureString(GetHeaderText(), GetNameFont(style),
        ...
        protected override void Deserialize(XmlElement node)
        {
            ...
            Collapsed = node["Collapsed"].GetValue(false);
            UpdateMinSize();
        }
        ...
        EditorWindow RelationShipEditor = new RelationShipEditor();

        protected override void OnActivated(EventArgs e)
        {
            base.OnActivated(e);
            RelationShipEditor.Relocate(this);
            ShowWindow(RelationShipEditor);
            RelationShipEditor.Init(this);
            RelationShipEditor.Focus();
        }
