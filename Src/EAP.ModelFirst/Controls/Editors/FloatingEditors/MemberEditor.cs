...
namespace EAP.ModelFirst.Controls.Editors.FloatingEditors
{
    ...
    public partial class MemberEditor : EditorWindow, ILocalizable
	{
		CompositeTypeShape shape = null;
		bool needValidation = false;

        class MemberEditorHandler : FloatingEditorHandler
        {
            MemberEditor editor { get { return Window as MemberEditor; } }
