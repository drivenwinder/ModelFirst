...
{
	internal sealed class UmlEnum : EnumType
	{
        internal UmlEnum()
		...
		/// </exception>
		internal UmlEnum(string name) : base(name)
		{
		}
		...
		{
			EnumValue newValue = new UmlEnumValue(declaration);
