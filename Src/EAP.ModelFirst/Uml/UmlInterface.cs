...
{
	internal sealed class UmlInterface : InterfaceType
	{
        internal UmlInterface()
		...
		/// </exception>
		internal UmlInterface(string name) : base(name)
		{
		}
		...
		{
            UmlInterface newInterface = new UmlInterface();
