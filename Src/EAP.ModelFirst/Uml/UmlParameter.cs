...
{
	internal sealed class UmlParameter : Parameter
	{
		/// <exception cref="BadSyntaxException">
		/// The <paramref name="name"/> or <paramref name="type"/> 
		/// does not fit to the syntax.
		/// </exception>
		internal UmlParameter(string name, string type, ParameterModifier modifier, string defaultValue)
		...
		{
			return new UmlParameter(Name, Type, Modifier, DefaultValue);
		}
	}
}
