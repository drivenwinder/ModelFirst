// EAP.ModelFirst - Free class diagram editor
...
{
	public sealed class UnifiedModelingLanguage : Language
	{
		static UnifiedModelingLanguage instance = new UnifiedModelingLanguage();
		...
		static UmlClass objectClass;

		static UnifiedModelingLanguage()
		{
            objectClass = UmlClass.CreateObjectClass();
			...
			validOperationModifiers = new Dictionary<OperationModifier, string>(7);
		...
		private UnifiedModelingLanguage()
		{
		}

        public static UnifiedModelingLanguage Instance
        {
            get { return instance; }
        }

        internal static UmlClass ObjectClass
        {
