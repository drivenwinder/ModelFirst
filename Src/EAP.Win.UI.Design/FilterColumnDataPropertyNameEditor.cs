...
{
    public class FilterColumnDataPropertyNameEditor: UITypeEditor
    {
        private DesignBindingPicker designBindingPicker;

        private FilterColumnDataPropertyNameEditor()
        {
        }
    ...
    internal class DesignBindingPicker : ContainerControl
    {
        ...
        public DesignBindingPicker()
        {
            ...
            this.treeViewCtrl.AccessibleName = "DesignBindingPickerTreeViewAccessibleName";
            ...
            this.addNewCtrl.Text = "DesignBindingPickerAddProjDataSourceLabel";
            ...
            Bitmap bitmap = new Bitmap(typeof(DesignBindingPicker), "Resources.AddNewDataSource.bmp");
            ...
            base.AccessibleName = "DesignBindingPickerAccessibleName";
                        ...
                        if (this.IsBindableDataMember(property))
                        {
                            ...
                            if (!this.selectListMembers || flag)
                            {
                                ...
                                if ((this.selectedItem != null) && (this.selectedItem.DataSource == node.DataSource))
                                {
                                    ...
                                    else if (this.selectedItem.DataMember.IsNotEmpty() && (this.selectedItem.DataMember.IndexOf(node.DataMember) == 0))
                                    {
                                        this.AddDataMemberContents(node);
                                    }
                                }
        ...
        private void AddDataSourceContents(TreeNodeCollection nodes, object dataSource, string dataMember, PropertyDescriptorCollection properties)
        {
            if (this.showDataMembers || (dataSource is BindingSource))
            {
                if (dataSource is System.Type)
                {
                    ...
                    {
                        if (DesignerUtils.IsCriticalException(exception))
                        {
                            throw;
                        }
                    }
        ...
        private void AddProjectDataSource(TreeNodeCollection nodes, DataSourceDescriptor dsd)
        {
            ...
            if ((type == null) || (type.GetType() == runtimeType))
            {
                ...
                nodes.Add(node);
                if ((this.selectedItem != null) && this.selectedItem.DataMember.IsNullOrEmpty())
                {
        ...
        private BindingSource CreateNewBindingSource(object dataSource, string dataMember)
        {
            ...
            catch (Exception exception)
            {
                ...
                FilterControlDesigner.ShowErrorDialog(uiService, exception, this);
                return null;
            }
            string bindingSourceNamePrefix = this.GetBindingSourceNamePrefix(dataSource, dataMember);
            if (this.serviceProvider != null)
            {
                bindingSourceNamePrefix = DesignerUtils.NameFromText(bindingSourceNamePrefix, component.GetType(), this.serviceProvider);
            }
            else
            {
            ...
            DesignerTransaction transaction = this.hostSvc.CreateTransaction("DesignerBatchCreateTool".FormatArgs(new object[] { uniqueSiteName }));
            try
            {
                try
                {
                ...
                catch (InvalidOperationException exception2)
                {
                    ...
                    FilterControlDesigner.ShowErrorDialog(service, exception2, this);
                    return null;
                }
                catch (CheckoutException exception3)
                {
                    ...
                    FilterControlDesigner.ShowErrorDialog(service3, exception3, this);
                    return null;
                }
        ...
        private void UpdateHelpText(BindingPickerNode mouseNode)
        {
            ...
            {
                this.helpTextCtrl.Text = string.Format(CultureInfo.CurrentCulture, "DesignBindingPickerHelpGenCurrentBinding", new object[] { this.selectedNode.Text });
            }
            else if (!this.showDataSources)
            {
                this.helpTextCtrl.Text = (this.treeViewCtrl.Nodes.Count > 1) ? "DesignBindingPickerHelpGenPickMember" : "";
            }
            else if ((this.treeViewCtrl.Nodes.Count > 1) && (this.treeViewCtrl.Nodes[1] is DataSourceNode))
            {
                this.helpTextCtrl.Text = "DesignBindingPickerHelpGenPickBindSrc";
            }
            else if ((this.instancesNode.Nodes.Count > 0) || (this.projectNode.Nodes.Count > 0))
            {
                this.helpTextCtrl.Text = "DesignBindingPickerHelpGenPickDataSrc";
            }
            else if (this.addNewPanel.Visible)
            {
                this.helpTextCtrl.Text = "DesignBindingPickerHelpGenAddDataSrc";
            }
            else
            {
        ...
        internal class BindingPickerTree : TreeView
        {
            ...
            {
                Image image = new Bitmap(typeof(DesignBindingPicker), "Resources.DataPickerImages.bmp");
        ...
        internal class DataSourceNode : DesignBindingPicker.BindingPickerNode
        {
            ...
            public override string HelpText
            {
                get
                {
                    ...
                    try
                    {
                        return string.Format(CultureInfo.CurrentCulture, "DesignBindingPickerHelpNode{0}{1}{2}", new object[] { str, str2, this.CanSelect ? "1" : "0" });
                    }
                    catch
                    {
                        return "";
        ...
        internal class InstancesNode : DesignBindingPicker.BindingPickerNode
        {
            public InstancesNode(string rootComponentName)
                : base(null, string.Format(CultureInfo.CurrentCulture, "DesignBindingPickerNodeInstances", new object[] { rootComponentName }), DesignBindingPicker.BindingPickerNode.BindingImage.Instances)
            {
            }
            ...
            public override string HelpText
            {
                get
                {
                    return "DesignBindingPickerHelpNodeInstances";
                }
            }
        }
        ...
        {
            public NoneNode()
                : base(null, "DesignBindingPickerNodeNone", DesignBindingPicker.BindingPickerNode.BindingImage.None)
            {
            }
            ...
            public override string HelpText
            {
                get
                {
                    return "DesignBindingPickerHelpNodeNone";
                }
            }
        }
        ...
        {
            public OtherNode()
                : base(null, "DesignBindingPickerNodeOther", DesignBindingPicker.BindingPickerNode.BindingImage.Other)
            {
            }
            ...
            public override string HelpText
            {
                get
                {
                    return "DesignBindingPickerHelpNodeOther";
                }
            }
        }
        ...
        internal class ProjectGroupNode : DesignBindingPicker.BindingPickerNode
        {
            ...
            public override string HelpText
            {
                get
                {
                    return "DesignBindingPickerHelpNodeProjectGroup";
                }
            }
        }
        ...
        internal class ProjectNode : DesignBindingPicker.BindingPickerNode
        {
            ...
            public override string HelpText
            {
                get
                {
                    return "DesignBindingPickerHelpNodeProject";
                }
            }
        }
    }
