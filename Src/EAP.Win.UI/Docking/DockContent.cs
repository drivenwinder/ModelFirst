...
{
    //There is a bug of refreshing docking document's visible area when using KryptonForm, 
    //so don't change the base type of DockContent from Form to KryptonForm
