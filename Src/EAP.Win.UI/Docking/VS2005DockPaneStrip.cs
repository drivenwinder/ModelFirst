...
namespace EAP.Win.UI
{
    internal class VS2005DockPaneStrip : DockPaneStripBase
    {
        ...
        private sealed class InertButton : InertButtonBase
        {
            ...
            {
                if (PaletteHelper.ColorDocumentActiveText != ForeColor)
                {
                    ForeColor = PaletteHelper.ColorDocumentActiveText;
                    Invalidate();
                }
            }
        }
            ...
            : base(pane)
        {
            ...
            BackColor = PaletteHelper.GetBackColor;
            KryptonManager.GlobalPaletteChanged += new EventHandler((object sender, EventArgs e) => { BackColor = PaletteHelper.GetBackColor; });
        }
        ...
        private void DrawTabStrip_Document(Graphics g)
        {
            ...
            g.DrawLine(PaletteHelper.PenDocumentTabActiveBorder, rectTabStrip.Left, rectTabStrip.Bottom - 1,
        ...
        private void DrawTabStrip_ToolWindow(Graphics g)
        {
            ...
            g.DrawLine(PaletteHelper.PenToolWindowTabBorder, rectTabStrip.Left, rectTabStrip.Top,
        ...
        protected override void OnMouseHover(EventArgs e)
        {
            ...
            {
                TabVS2005 tab = Tabs[index] as TabVS2005;
                if (tab.Content.DockHandler.ToolTipText.IsNotEmpty())
