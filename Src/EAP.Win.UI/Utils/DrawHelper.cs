...
namespace EAP.Win.UI.Utils
{
    ...
    {
        public static SizeF GetFontSize(string text, System.Drawing.Font font)
        {
            Graphics g = Graphics.FromHwnd(System.IntPtr.Zero);
            g.PageUnit = GraphicsUnit.Display;
            return g.MeasureString(text, font, new SizeF(0f, 0f));
        }
